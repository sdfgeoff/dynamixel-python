class Protocol2Bus:
	def __init__(self, uart, max_timeout=0.1):
	...
	def send_and_wait(self, address, instruction, parameters):
		...
		a response. If a valid response is retrieved, it returns the data. 
		...
		# ~ data = None
		# ~ buff = b''
		# ~ while time.time() < send_time + self.max_timeout:
